...
class Logic implements ActionListener{
	...
	public void xWins(int a,int b,int c) {
		buttonGrid[a].setBackground(Color.GREEN);
		buttonGrid[b].setBackground(Color.GREEN);
		buttonGrid[c].setBackground(Color.GREEN);
	...
	private void PlayAgain() {
		...
		Xscore.setForeground(Color.GREEN);
		...
		Oscore.setForeground(Color.GREEN);
